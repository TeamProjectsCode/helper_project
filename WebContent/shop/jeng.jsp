		...
		<div class="product_view">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<th>결제포인트</th>
						<td class="total"><b>29,900</b></td>
					</tr>
				</tbody>
			</table>
			<div class="img">
				<img src="../images/jenggg.jpg" alt="">
				<ul>
					<li class="on"><a href="#a"><img src="../images/jenggg.jpg"
							alt=""></a></li>
				</ul>
			</div>
			<div class="btns">
